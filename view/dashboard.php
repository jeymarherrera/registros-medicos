            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="view/signin.php" class="dropdown-item">Sign In</a>
                            <a href="view/signup.php" class="dropdown-item">Sign Up</a>
                            <a href="view/404.php" class="dropdown-item">404 Error</a>
                            <a href="view/blank.php" class="dropdown-item">Blank Page</a>
                        </div>
                    </div>
                </div>
            </nav>
